    ...
    <div class="container">
                ...
                <div class="col-xs-8">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Novo Header - Contato</h3>
                        </div>
                        <div class="box-body" style="background: #EEEEEE">
                            <div class="col-xs-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <button class="btn btn-primary" formaction="{{url('adm/savecontato')}}" formmethod="post">ADICIONAR</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Headers-Contato Cadastrados</h3>
                        ...
                        <table id="contato" class="table table-hover">
                            ...
                            @foreach($contato as $con)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{asset('/images/contato/'.$con->img)}}" width="190" height="40">
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <a href="{{url('adm/contato_status/'.$con->id)}}">
