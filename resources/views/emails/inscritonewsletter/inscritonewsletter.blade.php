                        ...
                        <div class="column" style="text-align: left;color: #60666d;font-size: 14px;line-height: 21px;font-family: Open Sans,sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;Margin-bottom: 24px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                                    <p class="size-20" style="Margin-top: 0;Margin-bottom: 0;font-size: 17px;line-height: 26px;text-align: center;" lang="x-size-20"><span style="color:#f5f7fa"><strong>Inscrição de Newsletter</strong></span></p>
                                </div>
                            </div>
                    ...
                    <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;" emb-background-style>
                        ...
                        <div class="column" style="text-align: left;color: #60666d;font-size: 14px;line-height: 21px;font-family: Open Sans,sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                                    <p class="size-16" style="Margin-top: 16px;Margin-bottom: 20px;font-size: 16px;line-height: 24px;text-align: left;" lang="x-size-16">

                                        Você receberá notícias e informações sobre o programa Envie Cartões.<br>

                                        Para deixar de seguir clique no botão abaixo.</p>
                                </div>
                            </div>
