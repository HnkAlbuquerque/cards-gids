...
class CartaoVertical extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject("Envie Cartões - Você recebeu um Cartão de $pedidoDetalhe->nome")
            ->view('emails.enviocartao.cartaovertical',compact('pedidoDetalhe','nts'));
